...
import { ImportReceipt } from '@/services/importReceiptService';
...
import styles from './ImportReceiptDetailModal.module.css';

interface AddImportReceiptModalProps {
  onClose: () => void;
  onSave: (newOrder: ImportReceipt) => void;
}

export default function AddImportReceiptModal({
  onClose,
  onSave,
}: AddImportReceiptModalProps) {
  ...
  const handleSave = () => {
    ...
    const newOrder: ImportReceipt = {
      id: Date.now(),
      code: code || `PNH00${Math.floor(Math.random() * 1000)}`,
      creator,
      notes,
      branch,
      supplierCode,
    ...
    <div className={styles.backdrop}>
      <div className={styles.container}>
        <div className={styles.header}>
          <h2 className={styles.headerTitle}>Thêm mới phiếu nhập hàng</h2>
            ...
            <div className={styles.leftCol}>
              <div className={styles.row}>
                <div className={styles.field} style={{ flex: 1 }}>
                  <label className={styles.label}>Mã nhập hàng <span style={{ color: 'var(--danger-color)' }}>*</span></label>
                  <input
                    type="text"
            ...
            <div className={styles.rightCol}>
              <div className={styles.card}>
                <div className={styles.cardHeader}>
                  ...
                  <div className={styles.cardSub}>Danh sách mặt hàng nhập</div>
                </div>
