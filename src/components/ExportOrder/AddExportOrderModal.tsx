...
interface AddExportOrderModalProps {
  onClose: () => void;
  onSave: (newOrder: ExportOrder) => void;
}

export default function AddExportOrderModal({
  onClose,
  onSave,
}: AddExportOrderModalProps) {
  ...
  const handleSave = () => {
    ...
    const newOrder: ExportOrder = {
      id: 0,
      code: code.trim(), // Backend will auto-generate if empty
      creator,
      notes,
      branch,
      customerCode,
    ...
    <div className={styles.backdrop}>
      <div className={styles.container}>
        <div className={styles.header}>
          <h2 className={styles.headerTitle}>Thêm mới phiếu đặt hàng xuất</h2>
